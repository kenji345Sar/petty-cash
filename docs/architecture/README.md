...
| 2 | [02-domain-model.md](02-domain-model.md) | モデルの一覧と関係、設計にないもの、各モデルが守っている業務ルール |
| 3 | [03-flow-to-code.md](03-flow-to-code.md) | 業務の操作ごとに、Controller → UseCase → Domain → DB と処理がどう流れるか。UseCase の一覧と、小口の赤伝を例にした各層の詳しい説明つき |
